Feature: Order products logged in-3
  ...
  Scenario: Login and Order with courier delivery and card payment (changes billing address)
  ...
  Scenario: Login and Order with courier delivery and pickup payment (changes billing address)
  ...
  Scenario:  Login and Order with courier delivery and card payment (changes shipping address, changes billing address)
  ...
  Scenario: Login and Order with courier delivery and pickup payment (changes shipping address, changes billing address)
